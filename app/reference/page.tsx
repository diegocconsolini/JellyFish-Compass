...
const SECTIONS: { id: SectionId; label: string }[] = [
  ...
  { id: "people_teams", label: "People & Teams" },
];
...
const peopleEndpointsRef =
  endpointGroups.find((g) => g.domain === "People")?.endpoints ?? [];
const teamsEndpointsRef =
            ...
            <div className="bg-surface rounded-xl border border-border p-5">
              ...
              <div className="space-y-2">
                {peopleEndpointsRef.map((ep) => (
                  <div
                    key={ep.name}
                    className="flex items-start gap-3 rounded-lg border border-border-vivid bg-bg p-3"
                  >
