...
const sectionIcons: Record<string, React.ReactNode> = {
  ...
  "/process": <GitBranch className="w-5 h-5 text-amber" />,
...
const sectionGroups = [
  {
    ...
    items: [
      ...
      { href: "/product-metrics", label: "Product Metrics", desc: "Investment, flow, quality & AI impact" },
      ...
      { href: "/process", label: "Process", desc: "Cycle time & handoff efficiency" },
    ],
  },
  {
    title: "Planning",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/reference", label: "Reference", desc: "25 endpoints, MCP, DORA, integrations & people" },
